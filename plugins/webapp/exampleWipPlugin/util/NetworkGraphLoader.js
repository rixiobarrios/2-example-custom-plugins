sap.ui.define([
    ...
    var oLogger = Logging.getLogger("sap.example.plugins.exampleWipPlugin.util.NetworkGraphLoader");

    var NetworkGraphLoader = BaseObject.extend("sap.example.plugins.exampleWipPlugin.util.NetworkGraphLoader", {
