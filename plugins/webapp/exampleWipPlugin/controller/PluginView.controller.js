sap.ui.define([
    ...
    "sap/example/plugins/exampleWipPlugin/util/NetworkGraphLoader"
    ...
    PluginViewController.extend("sap.example.plugins.exampleWipPlugin.controller.PluginView", {
        onInit: function () {
        ...
        openOrderDetail: function (oNode, oButton) {
            ...
            var that = this;
            if (!this._oQuickOrderView) {
                var sFragment = "sap.example.plugins.exampleWipPlugin.view.fragments.OrderFragment";
        ...
        openSfcDetail: function (oNode, oButton) {
            ...
            var that = this;
            if (!this._oQuickSfcView) {
                var sFragment = "sap.example.plugins.exampleWipPlugin.view.fragments.SfcFragment";
